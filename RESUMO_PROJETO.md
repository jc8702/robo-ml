...
- **29/07/2026 - 16:56:** Conexão com banco Neon PostgreSQL realizada e tabelas `sent_history` e `price_history` criadas com sucesso na nuvem. Variável `DATABASE_URL` adicionada ao `.env`. Repositório Git inicializado e código enviado para o GitHub no repositório oficial: `https://github.com/jc8702/robo-ml.git`.
