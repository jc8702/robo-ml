...
- **29/07/2026 - 18:07:** Solução definitiva para a Vercel. Criado o arquivo `index.html` diretamente na raiz do repositório e simplificado o `vercel.json` com `{ "cleanUrls": true }`. A Vercel agora entrega a rota `/` (`https://robo-ml-psi.vercel.app/`) como um ativo estático de altíssima velocidade via CDN global, eliminando 100% qualquer tentativa de execução de Serverless Function na raiz do site.
